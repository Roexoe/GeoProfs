...
export function Reports({ user }: ReportsProps) {
  ...
  const topUsers = [
    { name: 'Maria Jansen', department: 'Landmeetkunde', daysUsed: 22, daysRemaining: 3, usage: 88 },
    { name: 'Pieter de Vries', department: 'GIS', daysUsed: 20, daysRemaining: 5, usage: 80 },
    { name: 'Anna van der Meer', department: 'Project', daysUsed: 19, daysRemaining: 6, usage: 76 },
    { name: 'Jan Willems', department: 'Landmeetkunde', daysUsed: 18, daysRemaining: 7, usage: 72 },
    { name: 'Lisa Bakker', department: 'Administratie', daysUsed: 17, daysRemaining: 8, usage: 68 }
  ]
